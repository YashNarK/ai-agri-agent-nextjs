...
//
// Served at /docs, mirroring where FastAPI puts its interactive docs,
// rather than at the site root. The root belongs to the dashboard: for
// a signed-in user the API index is not the thing they came for, and a
// landing page that only lists endpoints made the app look like a
// service with no product attached.
//
